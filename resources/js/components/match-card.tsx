...
export default function MatchCard({ homeTeam, awayTeam, venueCity, status, timer, date, venue, id, time, sort, isLive, slug }: FixtureMatch) {
    ...
    return (
        <Link
            ...
            className="mx-0.5 block h-full w-full cursor-pointer overflow-x-hidden rounded-sm border-2 border-gray-100 px-3 py-8 shadow-xs hover:border-blue-100"
        >
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <div className="flex flex-1 cursor-pointer flex-col items-center gap-y-1">
                                <div className="mb-2 flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-gray-100 p-0.5">
                                    <img
                                ...
                                <div className="w-20">
                                    <h3 className="line-clamp-1 text-center text-xs font-semibold text-black">{homeTeam.name}</h3>
                                </div>

                                {/* <div className="flex rounded-full py-0.5">
                                    <h3 className="text-xs font-semibold text-black">{homeTeam.name}</h3>
                                </div> */}
                            </div>
                        </TooltipTrigger>
                ...
                <div className="relative flex flex-col items-center justify-center gap-y-3">
                    ...
                    {statusTemp.includes(status.toLowerCase()) ? (
                        <div className="relative flex flex-col items-center justify-center whitespace-nowrap">
                            ...
                            <div className="flex items-center gap-x-1 rounded-sm bg-gray-300 p-1">
                        ...
                        <div className="flex w-24 flex-col items-center justify-center">
                            <div className="flex justify-center gap-x-1 rounded-sm bg-gray-300 px-1.5 py-1">
                    ...
                    <Tooltip>
                        <TooltipTrigger>
                            <div className="flex flex-1 cursor-pointer flex-col items-center gap-y-1 px-1">
                                ...
                                <div className="w-20">
                                    <h3 className="line-clamp-1 text-center text-xs font-semibold text-black">{awayTeam.name}</h3>
                                </div>
                            </div>
                        </TooltipTrigger>
                        <TooltipContent className="bg-blue-950">
